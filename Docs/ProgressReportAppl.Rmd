...
plot(mid, fpca_mod$efunctions[, 1], pch=16, xlab="bin", ylab="PC1", col = "blue",
     cex = 0.5)
lines(1:J, df_phi[, 1])

plot(mid, fpca_mod$efunctions[, 2], pch=16, xlab="bin", ylab="PC2", col = "blue",
     cex = 0.5)
lines(1:J, df_phi[, 2])

plot(mid, fpca_mod$efunctions[, 3], pch=16, xlab="bin", ylab="PC3", col = "blue",
     cex = 0.5)
lines(1:J, df_phi[, 3])

plot(mid, fpca_mod$efunctions[, 4], pch=16, xlab="bin", ylab="PC4", col = "blue",
     cex = 0.5)
lines(1:J, df_phi[, 4])
```
