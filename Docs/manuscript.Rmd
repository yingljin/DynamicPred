...
cols <- c("0.2"= "#FDCC8A", "0.4"="#FC8D59", "0.6"="#E34A33", "0.8"="#B30000", "True"="#000000")
# brewer.pal(5, "OrRd")
...
```{r fig_small_sim, fig.height=8, fig.width=8}
bind_rows(
...
```{r auc_fGFPCA_nhanes, eval=FALSE}
...
```{r auc_GLMMadaptive_nhanes, eval=FALSE}
...
```{r pred_nhanes, fig.height=4, fig.width=10, eval=FALSE}
