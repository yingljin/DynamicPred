...
- Did bias improved performance? The lines above look like so. I also wanna see the squared errors and AUC.
...
auc1 <- split(auc1, f = auc1$window)

tb_auc1 <- matrix(NA, 5, 4)

for(i in 2:4=5){
  
  this_lst <- auc1[i:5]
  
  for(j in seq_along(this_lst)){
     tb_auc[ ,i]
