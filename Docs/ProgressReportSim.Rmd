...
Below I compared the predictions using scaled and unscaled parameters: 



```{r, fig.height=8, fig.width=8}
par(mfrow = c(2, 2))
plot(df_pred$pred0.2, df_pred3$pred0.2, pch=20, cex = 0.5,
     main = "Up to 0.2", xlab = "Unscaled", ylab = "Scaled")
plot(df_pred$pred0.4, df_pred3$pred0.4, pch=20, cex = 0.5,
     main = "Up to 0.4", xlab = "Unscaled", ylab = "Scaled")
plot(df_pred$pred0.6, df_pred3$pred0.6, pch=20, cex = 0.5,
     main = "Up to 0.6", xlab = "Unscaled", ylab = "Scaled")
plot(df_pred$pred0.8, df_pred3$pred0.8, pch=20, cex = 0.5,
     main = "Up to 0.8", xlab = "Unscaled", ylab = "Scaled")
```
