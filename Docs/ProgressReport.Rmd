...
- In fact there are two scenarios where GLMMadaptive overperforms fGFPCA slightly: 1) given 9am to predict 1-5pm; and 2) given 1pm and predict 5-9pm. Both of them have a 4-hour interval apart from the maximum observation time and and prediction window. Could it have anything to do the cyclic trend in the data? Is 4h the length of a cycle? I tried to look at it but really couldn't see anything...there are too many points lumped together! 
...
- Should I calculate subject-wise AUC and average them? But some subjects are all zero within the predictio window, making AUC for this single subjects impossible to calculate...
