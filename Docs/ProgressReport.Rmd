...
The bias was caused by the misspecification of latent process (assume constant effect over smooth function). And what needs re-evaluation are eigenvalues. Basis functions and mean functions are not biased. 
