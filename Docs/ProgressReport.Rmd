...
sum(fpca_mod$VarMats[[1]]!=fpca_mod$VarMats[[2]]) 
...
- $\mathcal{T}_s$: all observation points in bin s
- $Y_i^s)$ all observations in bin s from subject i
