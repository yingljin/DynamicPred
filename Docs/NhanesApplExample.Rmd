...
I'd like to investigate with different sample sizes.

```{r, cache=TRUE, results='hide'}
# sample size 
N_sub <- rep(500, 4)
fpca_model_list <- list()
interp_pc_est <- list()
debias_model_list <- list()
time_vec <- rep(NA, length(N_sub))

pb <- txtProgressBar(min=0, max = length(N_sub), style = 3)
