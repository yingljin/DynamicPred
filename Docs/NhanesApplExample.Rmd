...
- The smoothing parameters from the mgcv::bam model: `r debias_glmm$sp[2:4]`
- The re-evaluated eigenvalues, which are inverse of the smoothing parameters above: `r 1/debias_glmm$sp[2:4]`
- The **biased** eigenvalues from FPCA (step 3): `r fpca_mod$evalues[1:3]`
...
fpca_mod$evalues/(1/debias_glmm$sp[2:4])
```
